...
def detect_html_structure(html_content: str) -> Tuple[bool, bool, bool]:
    ...
    Returns:
        Tuple of (has_html_tag, has_head_tag, has_body_tag)
    """
    ...
    return has_html, has_head, has_body


def is_full_html_document(html_content: str) -> bool:
    """
    Determine if the HTML content is a full valid HTML document.

    A full HTML document should have both <html> and <body> tags.
